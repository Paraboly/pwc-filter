...
- Put a script tag similar to this `<script type="module" src="https://unpkg.com/@paraboly/pwc-filter@latest/dist/pwc-filter/pwc-filter.esm.js"></script>` in the head of your index.html
